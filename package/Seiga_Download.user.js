...
(function() {
  'use strict';
  var addLink, addLink_old, download, filename, getFileName, getFileNameSetting, getFileName_old, getImageCreator, getImageCreatorID, getImageCreator_old, getImageID, getImageID_old, getImagePageURL, getImageTitle, getImageTitle_old, getImageType, getImageURL, getImageURL_old, url;
  ...
  getFileName_old = function() {
    var creator, dfd, id, title;
    creator = getImageCreator_old();
    title = getImageTitle_old();
    id = getImageID_old();
    if ((creator != null) && (title != null) && (id != null)) {
      return getFileNameSetting().pipe(function(filename_setting) {
        return filename_setting.replace(/\?(member-name|title|illust-id)\?/g, function(match, group) {
          return data[group];
        });
      });
    } else {
